...
export function AuthForm({ initialMode = 'login' }: { initialMode?: 'login' | 'signup' }) {
  ...
  return (
    <div className="w-full max-w-md">
      <div className="mb-8 flex items-center gap-3"><div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-emerald-400/25 bg-emerald-400/10 text-emerald-300"><span className="text-xl font-black">~</span></div><div><div className="text-sm font-black tracking-[0.2em] text-white">IDX SENTINEL AI</div><div className="text-[10px] uppercase tracking-[0.18em] text-slate-500">Institutional intelligence</div></div></div>
